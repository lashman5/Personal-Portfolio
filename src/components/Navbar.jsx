...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR fixed top-0 left-0 w-full p-5 font-['Poppins'] max-sm:p-2 max-sm:max-h-[48px] bg-[#e2e2e2ab]/80 dark:bg-[#121212]/80 backdrop-blur-lg z-50">
